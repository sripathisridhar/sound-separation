...
SSDATA_URL="https://zenodo.org/records/4012661/files/FUSS_ssdata.tar.gz"

# The archive file is assumed to include a top folder named ssdata_reverb.
SSDATA_REVERB_URL="https://zenodo.org/records/4012661/files/FUSS_ssdata_reverb.tar.gz"

# The fsd data archive file is assumed to include a top folder named fsd_data.
FSD_DATA_URL="https://zenodo.org/records/4012661/files/FUSS_fsd_data.tar.gz"

# The rir data archive file is assumed to include a top folder named rir_data.
RIR_DATA_URL="https://zenodo.org/records/4012661/files/FUSS_rir_data.tar.gz"
